...
function Home() {
  ...
  let getRestaurantListByLocationId = async () => {
    let url =
      "http://localhost:3040/get-restaurant-list-by-loc-id/" +
          ...
          <div className="search w-50 gap-lg-2 d-flex align-items-start mt-3">
            <div id="location-input" className="w-75 position-relative mb-3">
              <input
                id="location-input"
                type="text"
                className="form-control mb-lg-0 w-100 me-lg-3 py-2 px-3"
                ...
                {restaurantList.list.map((restaurant, index) => {
                  return (
                    <li
                      ...
                      className="list-group-item"
                      onClick={() =>
                        navigate("/restaurants-details/" + restaurant._id)
                      }
                    >
                      <img
                        style={{
